...
const editinfo = () => {
  ...
  return (
    <SafeAreaView className="bg-[#FAFAFA] flex-1">
      ...
      >
        <CustomHeader title={t('titleprofile')} rightIcon={images.setting} onRightPress={() => router.push("/screens/Setting")} />
        ...
        <View className="bg-white rounded-xl p-2 shadow-md">
          ...
          <View className="mb-5 rounded-lg p-3 flex-row items-center">
            ...
            <View className="flex-1">
              <Text className="text-gray-100 text-left font-[400]">{t('lbladdres1')}</Text>
          ...
          <View className="mb-5 rounded-lg p-3 flex-row items-center">
            ...
            <View className="flex-1">
              <Text className="text-gray-100 text-left font-[400]">{t('lbladdres2')}</Text>
